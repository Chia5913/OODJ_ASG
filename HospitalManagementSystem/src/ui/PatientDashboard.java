...
/**
 * Patient Portal Dashboard – scaffold.
...
public class PatientDashboard extends JFrame {
    ...
    private final Patient currentUser;
    ...
    public PatientDashboard(Patient user) {
        ...
        setTitle("Patient Portal – " + user.getName());
        ...
        contentPanel.add(buildPlaceholderPanel("Book Appointment", "Teammate: implement this panel. Same Theme + scroll pattern as Doctor module."), "BOOK");
        contentPanel.add(buildPlaceholderPanel("My Appointments", "Teammate: implement this panel. Same Theme + scroll pattern as Doctor module."), "APPTS");
        contentPanel.add(buildPlaceholderPanel("Medical History", "Teammate: implement this panel. Same Theme + scroll pattern as Doctor module."), "HISTORY");
        contentPanel.add(buildPlaceholderPanel("Feedback", "Teammate: implement this panel. Same Theme + scroll pattern as Doctor module."), "FEEDBACK");
    ...
    private JPanel buildSidebar() {
        ...
        JLabel roleLbl = new JLabel("Patient Portal");
    ...
    private JPanel buildHomePanel() {
        ...
        JLabel sub = new JLabel("<html>Patient scaffold. Implement: browse doctor slots, book/reschedule/cancel, view medical history & prescriptions, submit ratings and comments.<br/>"
